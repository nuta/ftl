...
impl<'a> AutogenCrateGenerator<'a> {
    ...
    pub fn generate(mut self) -> anyhow::Result<()> {
        ...
        cargo_toml.push_str(r#"serde = { version = "1.0", default-features = false, features = ["derive", "alloc"] }"#);
...
pub fn main(args: &Args) -> anyhow::Result<()> {
    ...
    for dir in &args.fiber_dirs {
        ...
        let SpecKind::Fiber(fiber_spec) = spec.spec;
