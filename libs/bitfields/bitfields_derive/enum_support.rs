...
fn parse(args: AttributeArgs<EnumAttr>, _enum_input: &ItemEnum, enum_span: Span) -> EnumDef {
...
pub fn bitfields_enum(
    ...
    quote! {
        ...
        impl ::ftl_bitfields::BitField for #enum_name {
            ...
            fn into_u64(value: #enum_name) -> u64 {
                ...
                debug_assert!(raw < (1 << <#enum_name as ::ftl_bitfields::BitField>::BITS as u64));
                raw
            }
        }
