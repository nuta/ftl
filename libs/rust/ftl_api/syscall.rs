...
pub fn syscall4(n: SyscallNumber, a0: isize, a1: isize, a2: isize, a3: isize) -> Result<isize, FtlError> {
    syscall(n, a0, a1, a2, a3, 0, 0)
}

pub fn syscall5(n: SyscallNumber, a0: isize, a1: isize, a2: isize, a3: isize, a4: isize) -> Result<isize, FtlError> {
    syscall(n, a0, a1, a2, a3, a4, 0)
}

pub fn syscall6(n: SyscallNumber, a0: isize, a1: isize, a2: isize, a3: isize, a4: isize, a5: isize) -> Result<isize, FtlError> {
...
pub fn channel_create() -> Result<(HandleId, HandleId), FtlError> {
    ...
    let handle0 = HandleId::from_raw(ret & HANDLE_ID_MASK).ok_or(FtlError::InvalidSyscallReturnValue)?;
    let handle1 = HandleId::from_raw(ret >> HANDLE_ID_BITS).ok_or(FtlError::InvalidSyscallReturnValue)?;
    Ok((handle0, handle1))
}

pub fn channel_send(handle: HandleId, header: usize, buf: &[u8], handles: &[HandleId]) -> Result<(), FtlError> {
    syscall6(
